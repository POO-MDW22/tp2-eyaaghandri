...
public class Main {
    public static void main(String[] args) {
        ...
        product1.afficherProduit();
        System.out.println(" methode of one parametre :");
        System.out.println(" le prodects est egaux :"+product1.comparer(product1));
        System.out.println(" le prodects est egaux :"+product1.comparer(product2));
        System.out.println(" methode of two parametre :");
        System.out.println(" le prodects est egaux :"+product1.comparer(product1,product1));
        System.out.println(" le prodects est egaux :"+product1.comparer(product1,product2));
